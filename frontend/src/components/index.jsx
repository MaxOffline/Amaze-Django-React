        ...
        <React.Fragment>
          ...
          <div className="menu-items">
            ...
            <ul className="nav-main-menu" ref="nav">
              <li
                className="products-lin"
                onClick={() => this.handleClick("/home/products")}
              >
                Products
              </li>

              <li
                className="sign-in-lin"
                onClick={() => this.handleClick("/home/login")}
              >
                Sign In
              </li>

              <li
                className="sign-up-lin"
                onClick={() => this.handleClick("/home/register")}
              >
                Sign Up
              </li>

              <li
                className="contact-us-lin"
                onClick={() => this.handleClick("/home/contact-us")}
              >
                Contact Us
              </li>
            </ul>
